...
## This script makes use of public releases of the Drosophila genome from Flybase (dmel_r6.32_FB2020_01)
## To retrieve the genome assembly file yourself:
# wget ftp.flybase.net/genomes/Drosophila_melanogaster/dmel_r6.32_FB2020_01/

### Script Details ###
# This is a script that I wrote to generate a genome index file for use in an RNAseq alignment
##
