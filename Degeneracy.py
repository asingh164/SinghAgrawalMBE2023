...
def define_sites():
	...
	# Amardeep's Modification of rht Degenerate dictionary
	# Removed TGA and TAG
	# CGC from 0fold_2 -> 0fold_12
	# CGT from 0fold_2 -> 0fold_12
	# CTC from 0fold_2 -> 0fold_12
	# CTT from 0fold_2 -> 0fold_12
